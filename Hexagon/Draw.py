...
def draw_hexagons(hexagons, isActual, config):
    ...
    if isActual:
        plt.savefig(config.images_path + uuid + "hex_actual.png", dpi=300)
    else:
        plt.savefig(config.images_path + uuid + "_hex.png", dpi=300)
